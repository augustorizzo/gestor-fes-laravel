...
class Model_Chave_Composta extends Model
{
     /* metodos para sobrescrever quando tiver chave composta */
     protected function setKeysForSaveQuery(Builder $query)
     {     
         foreach($this->getKeyName() as $chave)
         {
             $query->where($chave, '=', $this->getAttribute($chave));
         }     
         return $query;
     }
