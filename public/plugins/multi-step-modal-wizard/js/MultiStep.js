! function(root, factory) {
    ...
    multiStep.prototype = {
        ...
        _buildModal: function() {
            ...
            this.element.html(`<div class="modal-dialog modal-dialog-centered modal-${this.options.modalSize} multi-step" role="document"><div class="modal-content ${this.options.classContentModal}"><div class="modal-header bg_primario text-white"><h5 class="modal-title" id="${id}LongTitle">${this.options.title}</h5><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button></div><div class="modal-body"></div><div class="modal-footer"></div></div></div>`);
            var $this = this;
